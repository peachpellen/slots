...
// in simulator we redefine to format for Slots Developer console
...
{\
	NSString * exceptionName = [@"org.slots." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.slots";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UISlotsNativeItemNone = -1, 
	UISlotsNativeItemSpinner = -2,
	UISlotsNativeItemProgressBar = -3,
	
	UISlotsNativeItemSlider = -4,
	UISlotsNativeItemSwitch = -5,
	UISlotsNativeItemMultiButton = -6,
	UISlotsNativeItemSegmented = -7,
	
	UISlotsNativeItemTextView = -8,
	UISlotsNativeItemTextField = -9,
	UISlotsNativeItemSearchBar = -10,
	
	UISlotsNativeItemPicker = -11,
	UISlotsNativeItemDatePicker = -12,
	
	UISlotsNativeItemInfoLight = -13,
	UISlotsNativeItemInfoDark = -14,
	
	UISlotsNativeItemDisclosure = -15,
	
	UISlotsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Slots instances of
